...
# Getting Started with Q3 IDE

This guide will help you get started with Q3 IDE.
...
Q3 IDE can be installed on Windows, macOS, and Linux. Visit the [download page](https://Q3 IDE.com/#install) for installation instructions.

## <a id="first-steps"></a>First Steps

After installing Q3 IDE, here are some first steps to get started:
...
Q3 IDE works just like Visual Studio Code, with a few differences:
