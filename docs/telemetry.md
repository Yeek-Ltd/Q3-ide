...
This page explains how Q3 IDE handles telemetry and how it enhances your privacy.

## Table of contents

- [Telemetry in Q3 IDE](#telemetry)
- [Replacements to Microsoft Online Services](#replacements)
- [Checking for telemetry](#checking)
- [Q3 IDE announcements](#announcements)
- [Malicious & deprecated extensions](#malicious-extensions)

## <a id="telemetry"></a>Telemetry in Q3 IDE
...
## <a id="announcements"></a>Q3 IDE announcements

The welcome page in Q3 IDE displays announcements that are fetched via the internet from the project's GitHub repository.
