...
APP_NAME="${APP_NAME:-Q3 IDE}"
APP_NAME_LC="$( echo "${APP_NAME}" | awk '{print tolower($0)}' )"
ASSETS_REPOSITORY="${ASSETS_REPOSITORY:-yeekcay/Q3-ide}"
BINARY_NAME="${BINARY_NAME:-q3ide}"
GH_REPO_PATH="${GH_REPO_PATH:-yeekcay/Q3-ide}"
ORG_NAME="${ORG_NAME:-yeekcay}"
