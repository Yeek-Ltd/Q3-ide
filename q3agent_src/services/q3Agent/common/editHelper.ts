 ...
 *
 * Ported from qwen-agents-cli (Apache 2.0, Copyright 2025 Google LLC).
 */
 ...
 *   2. Attempt to find the literal text inside fileContent.
...
/**
 * Counts the number of non-overlapping occurrences of substr inside source.
 * Returns 0 when the substring is empty.
 */
 ...
 * surrounding context. Compares old and new content line-by-line from both
 * ends to locate the changed region.
 */
