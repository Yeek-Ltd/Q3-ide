...
if [[ "${VSCODE_ARCH}" == "x64" ]]; then
  ...
  if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
    sed -i 's/generate_type2_appimage/generate_type2_appimage -u "gh-releases-zsync|Q3 IDE|Q3 IDE-insiders|latest|*.AppImage.zsync"/' pkg2appimage.AppDir/AppRun
  else
    sed -i 's/generate_type2_appimage/generate_type2_appimage -u "gh-releases-zsync|Q3 IDE|Q3 IDE|latest|*.AppImage.zsync"/' pkg2appimage.AppDir/AppRun
  fi
  ...
  # workaround that enforces x86 ARCH for pkg2appimage having /__w/Q3 IDE/Q3 IDE/build/linux/appimage/Q3 IDE/Q3 IDE.AppDir/usr/share/q3ide/resources/app/node_modules/rc/index.js is of architecture armhf
  export ARCH=x86_64
